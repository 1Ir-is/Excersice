...
public class ContentGenerationRequestDTO {
    ...
    @Schema(description = "Type and length of content to generate", example = "long_article", allowableValues = {"social_post",      // 200-400 words
    ...
    @Schema(description = "Target platform for the content", example = "linkedin", allowableValues = {"facebook", "instagram", "linkedin", "twitter", "blog", "website", "email"})
    private String targetPlatform = "facebook";

    @Schema(description = "Target audience for the content", example = "business_owners", allowableValues = {"general", "business_owners", "young_professionals", "students", "tech_enthusiasts"})
