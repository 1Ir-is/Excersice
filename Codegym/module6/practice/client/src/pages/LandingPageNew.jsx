  ...
  const features = [
    {
      ...
      description:
        "Tối ưu hóa chiến dịch marketing với AI và machine learning để đạt ROI cao nhất.",
    },
    {
      icon: (
      ...
      description:
        "Lên lịch và tự động đăng bài trên tất cả các nền tảng social media một cách dễ dàng.",
    },
    {
      icon: (
      ...
      description:
        "Báo cáo chi tiết và insights thông minh giúp bạn hiểu rõ khách hàng và thị trường.",
    },
    {
      icon: (
      ...
      description:
        "Tạo nội dung chất lượng cao tự động với AI, phù hợp với thương hiệu và đối tượng khách hàng.",
    },
  ];
  ...
  const testimonials = [
    {
      ...
      content:
        "PostLab đã giúp chúng tôi tiết kiệm 70% thời gian trong việc quản lý social media và tăng engagement rate lên 150%.",
      avatar:
    ...
    },
    {
      ...
      content:
        "Với PostLab, doanh thu từ social media của chúng tôi đã tăng 300% chỉ trong 3 tháng đầu sử dụng.",
      avatar:
    ...
    },
    {
      ...
      content:
        "Tính năng AI content generation thật sự ấn tượng. Nội dung được tạo ra rất sáng tạo và phù hợp với brand voice.",
      avatar:
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="animate-fade-in">
              ...
              <p className="text-xl text-gray-600 leading-relaxed mb-8 max-w-lg">
                Tăng hiệu quả marketing lên 10x với nền tảng tự động hóa toàn
                diện. Quản lý social media, tạo content AI và phân tích dữ liệu
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Khám phá những tính năng mạnh mẽ giúp doanh nghiệp của bạn phát
              triển nhanh chóng
            </p>
          </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Hàng nghìn doanh nghiệp đã tin tưởng và đạt được thành công với
              PostLab
            </p>
          </div>
      ...
      <section className="py-24 bg-gradient-to-br from-primary-600 via-primary-700 to-primary-800 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Tham gia cùng hàng nghìn doanh nghiệp đang sử dụng PostLab để phát
            triển marketing thông minh
          </p>
          <button
            onClick={() => navigate("/register")}
          ...
          <div className="grid lg:grid-cols-4 gap-8 mb-8">
            <div className="lg:col-span-1">
              ...
              <p className="text-gray-400 mb-4">
                Nền tảng tự động hóa marketing toàn diện giúp doanh nghiệp phát
                triển bền vững.
              </p>
            </div>
            <div>
